...
export default function Hero() {
  return (
    <div id="top" className="mx-auto max-w-5xl px-6 pt-16 pb-20 sm:pt-24 sm:pb-24">
        ...
        <div>
          ...
          <div className="mt-8 flex flex-wrap items-center gap-3">
            <a
              ...
              download
              className="inline-flex items-center gap-2 rounded-md bg-blue-700 px-4 py-2.5 text-sm font-medium text-white transition hover:bg-blue-800 focus-visible:ring-2 focus-visible:ring-blue-600 focus-visible:ring-offset-2 focus-visible:outline-none dark:bg-sky-500 dark:hover:bg-sky-400 dark:focus-visible:ring-offset-slate-950"
            >
            ...
            <a
              ...
              className="inline-flex items-center gap-2 rounded-md border border-slate-300 px-4 py-2.5 text-sm font-medium text-slate-700 transition hover:bg-slate-50 dark:border-slate-700 dark:text-slate-300 dark:hover:bg-slate-800"
            >
        ...
        <div className="order-first md:order-last">
          <picture>
            ...
            <img
              ...
              height={1840}
              fetchPriority="high"
              className="mx-auto h-56 w-56 rounded-full border border-slate-200 bg-slate-100 object-cover object-top sm:h-64 sm:w-64 dark:border-slate-800 dark:bg-slate-900"
            />
          </picture>
        </div>
      </div>
